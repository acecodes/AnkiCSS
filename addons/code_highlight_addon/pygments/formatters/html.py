...
CSSFILE_TEMPLATE = '''\
td.linenos { background-color:0; }
span.lineno { background-color:0; }
pre { line-height: 125%%; }
%(styledefs)s
'''
...
class HtmlFormatter(Formatter):
    ...
    *New in Pygments 0.7.*
    ...
    def __init__(self, **options):
        ...
        self.nobackground = get_bool_opt(options, 'nobackground', True)
    ...
    def _wrap_tablelinenos(self, inner):
        ...
        if nocls:
            yield 0, ('<table class="%stable">' % self.cssclass +
                      ...
                      'style="background-color:0; padding-right: 10px">'
    ...
    def _wrap_inlinelinenos(self, inner):
        ...
        if self.noclasses:
            if sp:
                for t, line in lines:
                    if num%sp == 0:
                        style = 'background-color:0; padding: 0 5px 0 5px'
                    else:
                        style = 'background-color:0; padding: 0 5px 0 5px'
                ...
                for t, line in lines:
                    yield 1, ('<span style="background-color:0; '
